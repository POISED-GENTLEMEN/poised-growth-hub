          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="relative z-10 p-12 md:p-16 min-h-[500px] flex flex-col justify-between">
                <div>
                  <Badge className="mb-4 bg-[#C1A36C] text-primary border-0">
                  ...
                  <p className="text-white/90 text-lg mb-6">
                    ...
                    Find your signature scent across 12 unique profiles.
                  </p>
                ...
                <div className="space-y-3">
                  <Button 
                    className="w-full bg-[#C1A36C] text-primary hover:bg-[#C1A36C]/90 font-semibold transition-transform group-hover:scale-105"
                  >
              ...
              <div className="relative z-10 p-12 md:p-16 min-h-[500px] flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-white/90 text-lg mb-6">
                    ...
                    Premium tools and experiences for teaching the next generation.
                  </p>
                  <div className="space-y-2 mb-8">
                    <div className="flex items-center gap-2 text-white">
                      <span className="text-[#C1A36C]">✓</span>
      ...
      <section className="py-16 px-4 md:px-8 bg-primary text-white text-center">
        <div className="container mx-auto max-w-3xl">
          ...
          <p className="text-lg text-white/90 mb-8">
            Take our 2-minute scent quiz for personalized recommendations
          </p>
          <Button 
            size="lg"
            ...
            {testimonials.map((testimonial, idx) => (
              <div key={idx} className="bg-muted rounded-lg p-8">
                ...
                <div className="border-t border-border pt-4">
                  ...
                  <p className="text-sm text-[#C1A36C]">
